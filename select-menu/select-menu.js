...
var $author$project$Menu$FocusList$selectionDecoder = function (prefix) {
	return A2(
		$elm$json$Json$Decode$andThen,
		function (id) {
			return A2($elm$core$String$startsWith, prefix, id) ? $elm$json$Json$Decode$oneOf(
				_List_fromArray(
					[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('No preferences')
										]))
								])),
							A3(
							$author$project$Menu$button,
			...
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Attributes$style, 'float', 'left'),
						A2($elm$html$Html$Attributes$style, 'width', '30%'),
						A2($elm$html$Html$Attributes$style, 'padding', '0.75em')
					]),
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(' Selected value: ')
							])),
						$elm$html$Html$text(model.selected)
					]))
			]));
};
